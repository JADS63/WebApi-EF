...
namespace WebApplicationJuaraujoda.Tests
{
    public class PlayersControllerTests
    {
        ...
        public async Task GetPlayers_WithPagination_ReturnsPaginatedResult()
        {
            ...
            stubService._players.AddRange(new List<Player>
            {
                new Player { Id = 1, FirstName = "Aryna", LastName = "Sabalenka", Height = 1.82, BirthDate = new System.DateTime(1998, 5, 5), HandPlay = HandPlay.Right, Nationality = "Belarus" },
                new Player { Id = 2, FirstName = "Iga", LastName = "Swiatek", Height = 1.76, BirthDate = new System.DateTime(2001, 5, 31), HandPlay = HandPlay.Right, Nationality = "Poland" }
            });
